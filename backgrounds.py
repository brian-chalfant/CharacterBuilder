...
def write_background():
    ...
    cur.execute('INSERT INTO backgrounds (NAME, SKILLPROF, LANGUAGES, EQUIPMENT, FEATURE, '
                ...
                '( \"{na}\",\"{sp}\",\"{la}\",\"{eq}\",\"{fe}\",\"{p1}\",\"{p2}\",\"{p3}\",\"{p4}\",\"{p5}\",\"{p6}\",'
                '\"{p7}\",\"{p8}\",\"{i1}\",\"{i2}\",\"{i3}\",\"{i4}\",\"{i5}\",\"{i6}\",\"{b1}\",\"{b2}\", '
                '\"{b3}\",\"{b4}\",\"{b5}\",\"{b6}\",\"{f1}\",\"{f2}\",\"{f3}\",\"{f4}\",\"{f5}\",\"{f6}\" )'.format(
                 na=NAME, sp=SKILLPROF, la=LANGUAGES, fe=FEATURE, eq=EQUIPMENT, p1=PERSTRAIT1, p2=PERSTRAIT2,
                 p3=PERSTRAIT3, p4=PERSTRAIT4, p5=PERSTRAIT5, p6=PERSTRAIT6, p7=PERSTRAIT7, p8=PERSTRAIT8, i1=IDEAL1,
                 i2=IDEAL2, i3=IDEAL3, i4=IDEAL4, i5=IDEAL5, i6=IDEAL6, b1=BOND1, b2=BOND2, b3=BOND3, b4=BOND4,
                 b5=BOND5, b6=BOND6, f1=FLAW1, f2=FLAW2, f3=FLAW3, f4=FLAW4, f5=FLAW5, f6=FLAW6))
    conn.commit()
    conn.close()
